...
from app.schemas import DailyReviewExportRequest, EvergreenExportRequest, ExportResponse
...
def export_daily(
    payload: DailyReviewExportRequest | None = None,
    ...
    post_ids = payload.post_ids if payload is not None else None
